...
const LOADING_TIPS = [
  ...
  'Спецприемы активны только при зажатой клавише направления',
  ...
  'Очки начисляются только за технику в связках',
  'Комбо требует смены направления хотя бы один раз',
  'Чем сложнее связка, тем ценнее награда. Стань легендой!',
