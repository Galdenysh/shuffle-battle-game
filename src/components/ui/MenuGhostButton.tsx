...
const buttonClasses = {
  base: 'w-fit min-h-8 flex items-center justify-center text-cyan-400/70 text-sm tracking-tighter underline underline-offset-4 decoration-cyan-500/30 cursor-pointer transition-all duration-300',
